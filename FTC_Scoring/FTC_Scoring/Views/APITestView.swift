...
//  FTC_Scoring
//
//  Created by Andrew Lee (with Claude) on 12/26/25.
//
...
struct APITestView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .navigationTitle("Team Performance Analysis")
            .onAppear() {
                fetchTeamEvents()
            }
        }
...
// MARK: - API Extension for Rankings

extension EventAPIService {
...
// MARK: - Team Ranking Model (if not already defined)

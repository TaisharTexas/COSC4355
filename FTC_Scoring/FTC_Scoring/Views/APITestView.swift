...
////                                .background(connectionStatus.contains("✅") ? Color.green.opacity(0.1) : Color.red.opacity(0.1))
////                                .cornerRadius(8)
////                        }
////                    }
//                    
...
//                        }
//                        
//                        Text("Shows all \(currentYear) events where the team competed")
//                            .font(.caption2)
...
//                Divider()
//                
//                // Raw JSON View (when enabled)
//                if showRawJSON && !rawJSON.isEmpty {
//                    VStack(alignment: .leading, spacing: 8) {
